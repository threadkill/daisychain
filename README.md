...
Binaries are currently available for __Windows10+ (x86_64)__ and __macOS-13+ (arm64)__ on the [Releases page](https://github.com/threadkill/daisychain/releases).
